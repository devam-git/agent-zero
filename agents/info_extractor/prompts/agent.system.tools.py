...
class InfoExtractorTools(VariablesPlugin):
    def get_variables(self, file: str, backup_dirs: list[str] | None = None, **kwargs) -> dict[str, Any]:
        ...
        for pf in prompt_files:
            ...
            if "info_extractor" in pf:
                # print(f"   ✅ Including info_extractor tool: {tool_name}")

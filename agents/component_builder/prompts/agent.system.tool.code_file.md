...
**Actions**:
- "create": Create a new code file in flows directory
...
- "list": List all code files in the flows directory
...
**File Location**:
- Files created are stored in `/a0/flow_builder/flows/` directory
...
~~~json
{
    "thoughts": ["Creating a new Python file for flow generation"],
    "headline": "Creating new code file",
    "tool_name": "code_file",
    "tool_args": {
        "action": "create",
        "file_name": "flow_builder",
        "file_extension": ".py"
    }
}
~~~
...
~~~json
{
    "thoughts": ["Writing flow generation code to the file"],
